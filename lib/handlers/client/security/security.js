...
SecurityClientHandler.prototype.send = function(ctx, callback) {
  ...
  //     this.encryptionHandler.applyMe(doc, this,
  //         function(encDoc) {
  //             doc = encDoc;
  //
...
function W3CXMLEncryption(options) {
    ...
    if(!this.options.key_hash)
        throw new Error("Require Private Key Hash");
    if (!this.options.input_encoding)
        this.options.input_encoding = 'utf-8';

}
W3CXMLEncryption.prototype.setReferences = function(ref) {
    this.options.xpathToContents = ref;
}
...
W3CXMLEncryption.prototype.applyMe = function(doc, security, callback) {
    ...
    return enc.encrypt(this.options, doc);
        // .then( function() {
        //     callback(doc);
        // })
        // .catch( function(err) {
